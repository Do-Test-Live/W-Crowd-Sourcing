                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="Update" method="post">
                                            ...
                                            ?>
                                            <div class="form-row">
                                                <div class="form-group col-md-4" id="time">
                                                    <label>Value of A</label>
                                                    <input type="number" class="form-control input-default" name="a" value="<?php echo $variable[0]['a'];?>">
                                                </div>
                                                <div class="form-group col-md-4" id="time">
                                                    <label>Value of B</label>
                                                    <input type="number" class="form-control input-default" name="b" value="<?php echo $variable[0]['b'];?>">
                                                </div>
                                                <div class="form-group col-md-4" id="time">
                                                    <label>Value of C</label>
                                                    <input type="number" class="form-control input-default" name="c" value="<?php echo $variable[0]['c'];?>">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary" name="variable">Submit Value</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
