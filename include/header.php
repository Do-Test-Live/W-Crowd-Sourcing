                    ...
                    <?php if($user_type == '1'){
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                ...
                                <?php
                                $notification = $db_handle->runQuery("select count(notification_id) as no from notification where user_id = '$userid' and status = '0'");
                                $no = $notification[0]['no'];
                                ?>
                                ...
                                <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380 ps">
                                    <ul class="timeline">
                                        ...
                                        for($i = 0; $i < $no_fetch_notification; $i++){
                                            ?>
                                            <li>
                                                <a href="Notification?question_id=<?php echo $fetch_notification[$i]['question_id'];?>&nid=<?php echo $fetch_notification[$i]['notification_id'];?>">
